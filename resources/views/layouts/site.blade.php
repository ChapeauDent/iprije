...
<head>
    ...
    <title>@yield('title', 'IPRIJE - Intelligence Artificielle & Programmation par le Jeu')</title>
    <meta name="description" content="@yield('meta_description', 'IPRIJE : Intelligence Artificielle, Programmation, Robotique, Initié par le Jeu. Solutions numériques innovantes pour Entreprises et Écoles.')">
    ...
    @vite(['resources/css/iprij.css', 'resources/js/app.js'])
</head>
<body>
    <header class="header">
        <nav class="navbar">
            <div class="container">
                <div class="nav-wrapper">
                    <div class="logo">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('images/logo.svg') }}" alt="Logo IPRIJE" class="logo-image">
                        </a>
                    </div>
                    <ul class="nav-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('services.office365') }}">Office 365 Business + IA</a></li>
                                <li><a href="{{ route('services.web') }}">Création Web & Apps GEO</a></li>
                                <li><a href="{{ route('services.marketing') }}">Stratégie Marketing</a></li>
                                <li><a href="{{ route('services.formation-ia') }}">Formation IA Génératives</a></li>
                                <li><a href="{{ route('services.formation-jeunes') }}">Formation des Jeunes</a></li>
                            </ul>
                        </li>
                        <li><a href="{{ route('blog.index') }}" class="nav-link">Blog</a></li>
                        <li><a href="{{ route('contact.show') }}" class="btn btn-primary">
                            On prend un café ?
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} IPRIJE - Tous droits réservés</p>

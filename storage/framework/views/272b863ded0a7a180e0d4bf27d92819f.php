...
<?php $__env->startSection('title', 'Mentions Légales - IPRIJE'); ?>
<?php $__env->startSection('description', 'Mentions légales du site IPRIJE : éditeur, hébergement, droits d\'auteur, responsabilités et informations légales.'); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="prose max-w-none">
            ...
            <section class="mb-8">
                ...
                <div class="bg-secondary-light p-6 rounded-lg">
                    ...
                    <div class="mt-4 space-y-2">
                        <p><strong>Email :</strong> <a href="mailto:contact@iprije.com" class="text-primary hover:underline">contact@iprije.com</a></p>
                        <p><strong>Téléphone :</strong> <a href="tel:+330650649241" class="text-primary hover:underline">+33 (0)6 50 64 92 41</a></p>
                        <p><strong>Formulaire de contact :</strong> <a href="<?php echo e(route('contact.show')); ?>" class="text-primary hover:underline">Nous écrire</a></p>
                    </div>
                </div>
            </section>
            ...
            <section class="mb-8">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <p><strong>Dernière mise à jour :</strong> <?php echo e(date('d/m/Y')); ?></p>

...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <p><strong>Nom :</strong> <?php echo e($nom); ?></p>
            <p><strong>Prénom :</strong> <?php echo e($prenom); ?></p>
            <p><strong>Email :</strong> <a href="mailto:<?php echo e($email); ?>"><?php echo e($email); ?></a></p>
            <p><strong>Téléphone :</strong> <?php echo e($telephone); ?></p>
        </div>
        
        <div style="background: white; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
            <h3 style="color: #2B4F75; margin-top: 0;">Message :</h3>
            <p style="white-space: pre-line;"><?php echo e($message); ?></p>
        </div>
...
</html><?php /**PATH C:\Users\ncsra\Herd\iprij\resources\views/emails/contact.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'IPRIJE - Intelligence Artificielle & Programmation par le Jeu | Formation & Solutions'); ?>
<?php $__env->startSection('meta_description', 'IPRIJE : Intelligence Artificielle, Programmation, Robotique, Initié par le Jeu. Solutions innovantes pour Entreprises et Écoles. Vernon, Normandie, France.'); ?>
        ...
        <div class="hero-content">
            ...
            <div class="hero-visual">
                ...
                <div class="logo-animation">
                    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="IPRIJ Logo" class="animated-logo-image">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="services-grid">
            ...
            <div class="service-card">
                <div class="service-image">
                    <img src="<?php echo e($service['image']); ?>" alt="<?php echo e($service['alt']); ?>" loading="lazy">
                    <div class="service-overlay"></div>
                </div>
                <div class="service-content">
                    <h3><?php echo e($service['title']); ?></h3>
                    <p><?php echo e($service['description']); ?></p>
                    <a href="<?php echo e($service['link']); ?>" class="service-link">En savoir plus →</a>
                </div>
            </div>
    ...
    <div class="container-fluid px-0">
        ...
        <div class="features-slanted-grid">
            ...
            <div class="feature-slanted-item">
                <img src="<?php echo e($feature['image']); ?>" alt="<?php echo e($feature['alt']); ?>" class="feature-background">
                <div class="feature-overlay"></div>
                <div class="feature-content">
                    <h3 class="feature-title"><?php echo e($feature['title']); ?></h3>
                    <div class="feature-hover-content">
                        <p class="feature-short"><?php echo e($feature['short_description']); ?></p>
                        <p class="feature-detailed"><?php echo e($feature['detailed_description']); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="zones-grid">
            <div class="zone-card">
                <div class="zone-header">
                    <img src="<?php echo e(asset('images/zones/normandie.svg')); ?>" alt="Normandie" class="zone-icon">
                    <h3>Local</h3>
                </div>
            ...
            <div class="zone-card">
                <div class="zone-header">
                    <img src="<?php echo e(asset('images/zones/normandie.svg')); ?>" alt="Normandie" class="zone-icon">
                    <img src="<?php echo e(asset('images/zones/ile-de-france.svg')); ?>" alt="Île-de-France" class="zone-icon">
                    <h3>Régional</h3>
                </div>
            ...
            <div class="zone-card">
                <div class="zone-header">
                    <img src="<?php echo e(asset('images/zones/france.svg')); ?>" alt="France" class="zone-icon">
                    <h3>National</h3>
                </div>
        ...
        <div class="blog-grid">
            ...
            <article class="blog-card">
                ...
                <div class="blog-card-content">
                    ...
                    <p class="blog-card-excerpt"><?php echo e($post->excerpt); ?></p>
                    ...
                    <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="blog-card-link">Lire la suite →</a>
                </div>
            </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div class="blog-cta">
            <a href="<?php echo e(route('blog.index')); ?>" class="btn btn-outline btn-lg">Découvrir le Blog</a>
        </div>
        <?php else: ?>
